...
const url = 'https://api.giphy.com/v1/stickers/search?api_key=6VT3WAW4gUpRwUV9UUdV4sTiNltrdin5&q=cats&limit=16&offset=0&rating=G&lang=en';
...
sendHTTPRequest(url, 'GET', (response) => {
  const nav = document.querySelector('.thumbnail');
  response.forEach(e => {
