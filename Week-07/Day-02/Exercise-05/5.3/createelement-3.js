...
kids.forEach(e => {
  let position = document.querySelector("#pets");
  let newArticle = document.createElement("article");
  let newP = document.createElement("p");
  let newH = document.createElement("h3");

  let appendH = newArticle.appendChild(newH);
  appendH.innerText = e.owner;
  let appendP = newArticle.appendChild(newP);
  appendP.innerText = e.petName;
